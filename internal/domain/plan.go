...
//
// It is built once by BuildPlan and then treated as immutable: Recommended and
// BestRisky point into Candidates' backing array rather than holding copies,
// which only stays safe because nothing appends to Candidates after BuildPlan
// returns. Do not mutate a built Plan's Candidates in place.
type Plan struct {
